...
int yeni_sehir_ekle()
{
    ...
    {
        printf("\nPlaka kodu 1 ile %d arasinda oldugu icin yeni sehir , siralama bozulamayacak sekilde listeye yerlestirilmitir..",son->plaka_kodu);
        secim=3;
    }
    switch(secim)
    {
                ...
                while(iter2!=NULL)
                {
                   // printf("\nHata2 :%s",iter2->sehir_adi);
                    ...
                    while(kiter!=NULL)
                    {
                        ...
                        // printf("\nHata burda2:%s  %d",iter2->sehir_adi,kiter->plaka_kodu2);
                        if(kiter->plaka_kodu2>a)
                        {
                            kiter->plaka_kodu2--;
                        }
                        //  printf("\nHata 3:%d",kiter->plaka_kodu2);
                        if(kiter->next_komsu==NULL)
                        {
                            break;
                        }
